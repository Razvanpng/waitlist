...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background animate-fade-in">
      <div className="hidden lg:flex w-1/2 bg-foreground text-primary p-16 flex-col justify-between animate-slide-right border-r-0">
        <div className="font-display text-3xl tracking-tighter">WAITLIST.</div>
        <div className="max-w-2xl">
          <h1 className="font-display text-[6rem] leading-[0.85] tracking-tight uppercase">
            Manage <br /> your time.
          </h1>
          <p className="mt-10 text-2xl text-background/80 leading-snug">
      ...
      <div className="flex w-full lg:w-1/2 flex-col justify-center px-8 py-12 md:px-16 lg:px-24 xl:px-32 relative shadow-2xl">
        <div className="w-full max-w-lg mx-auto animate-slide-up">
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-10">
            ...
            <button
              ...
              className="mt-6 flex w-full items-center justify-center bg-foreground py-6 text-xl font-bold uppercase tracking-widest text-background transition-all hover:bg-primary hover:text-foreground disabled:opacity-50"
            >
